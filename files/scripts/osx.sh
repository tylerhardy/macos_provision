...
c -c "Set :StandardViewSettings:IconViewSettings:iconSize 80" ~/Library/Preferences/com.apple.finder.plist

# Arrange All Finder Icons By Name
 # Set sort method
...
# Set the dock magnification (Not Working )
# NEed to have magnification checkbox enabled
# I dont think you can control checkboxes using defaults write
...
###############################################################################
# Google Chrome & Google Chrome Canary  ( I dont use chrome )                                       #
###############################################################################
